...
namespace SA.Analytics.Google {
	...
	public class Client  {
		...
		public void SetEventValue(int val) {
			AppendData("ev", val.ToString(), "", 0, HitType.EVENT);
		}
		...
		public void SetTransactionRevenue(float tr) {
			AppendData("tr", FloatToCurrency(tr), "", 0,  HitType.TRANSACTION);
		}

		public void SetTransactionShipping(float ts) {
			AppendData("ts", FloatToCurrency(ts), "", 0,  HitType.TRANSACTION);
		}

		public void SetTransactionTax(float tt) {
			AppendData("tt", FloatToCurrency(tt), "", 0,  HitType.TRANSACTION);
		}
		...
		public void SetItemPrice(float ip) {
			AppendData("ip", FloatToCurrency(ip), "", 0,  HitType.ITEM);
		}

		public void SetItemQuantity(int iq) {
			AppendData("iq", iq.ToString(), "", 0,  HitType.ITEM);
		}
		...
		public void SetPageDownloadTime(int time) {
			AppendData("pdt", time.ToString(), "", 0,  HitType.TIMING);
		}

		public void SetRedirectResponseTime(int time) {
			AppendData("rrt", time.ToString(), "", 0,  HitType.TIMING);
		}

		public void SetTCPConnectTime(int time) {
			AppendData("tcp", time.ToString(), "", 0,  HitType.TIMING);
		}


		public void SetServerResponseTime(int time) {
			AppendData("srt", time.ToString(), "", 0,  HitType.TIMING);
		}
		...
		public void SetIsFatalException(bool isFatal) {
			...
			AppendData("exf", data, "", 0,  HitType.EXCEPTION);
		}
